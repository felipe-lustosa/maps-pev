...
const ModalObjectives = ({ open, handleClose }) => {
  return (
      ...
      <div className={style}>
        ...
        <div className='flex flex-col gap-4 px-8 py-4 max-h-[calc(80vh)]'>
          <div className='border-b border-gray-500 mx-auto'>
            <h3 className='text-3xl font-semibold tracking-wide'>Objetivos</h3>
          </div>
          <div className='flex flex-col gap-8'>
            {pageData.objectivesPageText.map((text) => {
...
export default ModalObjectives